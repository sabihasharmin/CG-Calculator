...
cal=Tk()
cal.title('CGPA calculator for 2nd semester')
operator=''
...
subject1=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='HUM4222/HUM4224',command=lambda:btnClick("1")).grid(row=1,column=0)
subject2=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='HUM4225',command=lambda:btnClick("+3")).grid(row=1,column=1)
subject3=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='MATH4221',command=lambda:btnClick("+3")).grid(row=1,column=2)
subject4=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='PHY4221',command=lambda:btnClick("+3")).grid(row=1,column=3)
subject5=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='PHY4222',command=lambda:btnClick("+.75")).grid(row=2,column=0)
subject6=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4201',command=lambda:btnClick("+3")).grid(row=2,column=1)
subject7=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4202',command=lambda:btnClick("+1.5")).grid(row=2,column=2)
subject8=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4203',command=lambda:btnClick("+3")).grid(row=2,column=3)
subject9=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4204',command=lambda:btnClick("+1.5")).grid(row=3,column=0)
subject10=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='CSE4271',command=lambda:btnClick("+2")).grid(row=3,column=1)
subject11=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='CSE4272',command=lambda:btnClick("+1.5")).grid(row=3,column=2)
