...
cal=Tk()
cal.title('CGPA calculator for 4th semester')
operator=''
...
subject1=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4401',command=lambda:btnClick("3")).grid(row=1,column=0)
subject2=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4403',command=lambda:btnClick("+3")).grid(row=1,column=1)
subject3=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4405',command=lambda:btnClick("+3")).grid(row=1,column=2)
subject4=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='PHY4421',command=lambda:btnClick("+3")).grid(row=1,column=3)
subject5=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='MATH4421',command=lambda:btnClick("+3")).grid(row=2,column=0)
subject6=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='HUM4421',command=lambda:btnClick("+2")).grid(row=2,column=1)
subject7=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='MATH4422',command=lambda:btnClick("+.75")).grid(row=2,column=2)
subject8=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4406',command=lambda:btnClick("+.75")).grid(row=2,column=3)
subject9=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4416',command=lambda:btnClick("+1")).grid(row=3,column=0)
subject10=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4404',command=lambda:btnClick("+.75")).grid(row=3,column=1)
subject11=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4418',command=lambda:btnClick("+1")).grid(row=3,column=2)
subject12=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4402',command=lambda:btnClick("+.75")).grid(row=3,column=3)
...
add=Button(cal,padx=16,bd=8,fg='maroon',font=('arial',20,'bold'),
            text='GPA',command=lambda:btnClick("/22")).grid(row=7,column=2)
