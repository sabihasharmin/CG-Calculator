...
cal=Tk()
cal.title('CGPA calculator for 6th semester')
operator=''
...
subject1=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='HUM4621',command=lambda:btnClick("3")).grid(row=1,column=0)
subject2=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4600',command=lambda:btnClick("+3")).grid(row=1,column=1)
subject3=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4601',command=lambda:btnClick("+3")).grid(row=1,column=2)
subject4=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4602',command=lambda:btnClick("+.75")).grid(row=1,column=3)
subject5=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4603',command=lambda:btnClick("+3")).grid(row=2,column=0)
subject6=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4604',command=lambda:btnClick("+.75")).grid(row=2,column=1)
subject7=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4605',command=lambda:btnClick("+3")).grid(row=2,column=2)
subject8=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE4606',command=lambda:btnClick("+.75")).grid(row=2,column=3)
...
add=Button(cal,padx=16,bd=8,fg='maroon',font=('arial',20,'bold'),
            text='GPA',command=lambda:btnClick("/24")).grid(row=7,column=2)
