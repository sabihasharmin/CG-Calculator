...
cal=Tk()
cal.title('CGPA calculator for 8th semester')
operator=''
...
subject1=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='Hum 4821',command=lambda:btnClick("3")).grid(row=1,column=0)
subject2=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='Hum 4823',command=lambda:btnClick("+3")).grid(row=1,column=1)
subject3=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='Phy 4821',command=lambda:btnClick("+2")).grid(row=1,column=2)
subject4=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE 4800',command=lambda:btnClick("+3")).grid(row=1,column=3)
subject5=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='EEE 4801',command=lambda:btnClick("+3")).grid(row=2,column=0)
subject6=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='Elec.with lab',command=lambda:btnClick("+3.75")).grid(row=2,column=1)
subject7=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),
            text='Elec.without lab',command=lambda:btnClick("+3")).grid(row=2,column=2)
...
add=Button(cal,padx=16,bd=8,fg='maroon',font=('arial',20,'bold'),
            text='GPA',command=lambda:btnClick("/20.75")).grid(row=7,column=2)
